      ...
      <div className="row homePageWrapperRow">
        <div className="col-md-7">
          <div className="homePageWrapper d-flex">
            <InfoCard color={["#1da256", "#48d483"]} />
            <InfoCard color={["#c012e2", "#eb64fe"]} />
            <InfoCard color={["#2c78e5", "#60aff5"]} />
            <InfoCard color={["#e1950e", "#f3cd29"]} />
            <InfoCard color={["#d30d56", "#ff478b"]} />
            <InfoCard color={["#2dd2a6", "#88f2d5"]} />
          </div>
        </div>
